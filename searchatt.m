...
% Last Modified by GUIDE v2.5 07-Apr-2018 15:40:02
...
function collegeid_Callback(hObject, eventdata, handles)
% hObject    handle to collegeid (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global collegeid;
collegeid= str2double(char(get(handles.collegeid,'String')));


% Hints: get(hObject,'String') returns contents of collegeid as text
%        str2double(get(hObject,'String')) returns contents of collegeid as a double


% --- Executes during object creation, after setting all properties.
function collegeid_CreateFcn(hObject, eventdata, handles)
% hObject    handle to collegeid (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
...
% handles    structure with handles and user data (see GUIDATA)
global collegeid;
if(ceil(log10(abs(collegeid)))<6)
    msgbox('Enter exact 6 digit ID','error ID');
