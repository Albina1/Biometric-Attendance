...
cla(handles.axPreview,'reset');
set(handles.axPreview,'xtick',[],'ytick',[],'Xcolor','w','Ycolor','w')
...
start(vid); 
% pause for 1.5 seconds to give our webcam a "warm-up" time
pause(1.5); 
% do capture!
trigger(vid);
% stop the preview
...
% % if exist('capturedImage.jpg', 'file')
% %         delete('capturedImage.jpg');        
% % end

% now write capt1 into file named captured.png
imwrite(capt1, 'capturedImage.jpg','jpg');
